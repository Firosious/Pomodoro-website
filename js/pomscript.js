class Timer {
  constructor(root) {
    ...
    this.el.reset.addEventListener("click", () => {
      const inputMinutes = prompt("Enter number of minutes to study:");
  ...
  studyIntervalSet(){
   document.getElementById("studyIntervalSet").innerHTML ++;
  }
  ...
  static getHTML() {
    return `
			...
			<button type="button" class="timer__btn timer__btn--reset">
				<span class="material-icons">Set Timer</span>
			</button>
		`;
  }
}
